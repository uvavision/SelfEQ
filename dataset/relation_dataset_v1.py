...
class relation_dataset_1(Dataset):
...
#         # print("2 ", exclusion)
#         # exclusion = ann['relation']['antonym']+ann['relation']['exclusion']
#         # exclusion = ann['relation']['antonym']
...
#         return image, template, synonym, antonym, hypernym, meronym, obj_b, union, torch.LongTensor([gt_mask_indicator])      
#         # return image, template, synonym, antonym, hypernym, meronym, torch.LongTensor([gt_mask_indicator])        
